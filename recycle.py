...
def display_message(heading,subheading):
    screen.draw.text(heading,fontsize=50,center = CENTRE,color="red")
    screen.draw.text(subheading,fontsize=20,center=(CENTRE_X,CENTRE_Y+30),color="yellow")
